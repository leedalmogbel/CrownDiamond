    ...
    <div class="row no-gutters">
                ...
                {{-- <div class="row">
                    <div class="col-sm-12 col-md-10 col-md-offset-2"> --}}
                        <div class="logo-title-container">
                            ...
                            @if($admin_logo_img == '')
                            <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ voyager_asset('images/diamond.png') }}" alt="Logo Icon">
                            @else
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-sidebar-logo">
                <img class="img-responsive flip fadeIn" src="{{URL::asset('assets/imgs/Logo.png')}}" alt="Logo Icon">
            </div>
